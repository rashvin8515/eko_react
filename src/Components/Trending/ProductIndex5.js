...
export default function ProductIndex5() {
  ...
  const filterProducts = () => {
    if (activeTab === "1") {
      ...
      const firstTenProducts = products.filter((product) =>  product.category === "Furniture").slice(4, 9);
  ...
  return (
    ...
    <Row>
    <Col>
      <Nav tabs className="mb-5 text-center nav nav-tabs d-inline-block justify-content-md-end">
        <NavItem>
          <NavLink
