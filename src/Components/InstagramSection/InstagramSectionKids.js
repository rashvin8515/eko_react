      ...
      <Container fluid className="p-0">
        <Row className="no-gutters">
          ...
          <Col lg="2" md="4" sm="6" className="col-6">
            <a className="insta-item" href="#">
              <img className="img-fluid" src="assets/images/kids/insta/01.jpg" alt="" />
              <div className="insta-icon"><i className="lab la-instagram"></i></div>
            </a>
          </Col>
          <Col lg="2" md="4" sm="6" className="col-6">
            <a className="insta-item" href="#">
              <img className="img-fluid" src="assets/images/kids/insta/02.jpg" alt="" />
              <div className="insta-icon"><i className="lab la-instagram"></i></div>
            </a>
          </Col>
          <Col lg="2" md="4" sm="6" className="col-6 order-lg-1">
            <a className="insta-item" href="#">
              <img className="img-fluid" src="assets/images/kids/insta/03.jpg" alt="" />
              <div className="insta-icon"><i className="lab la-instagram"></i></div>
            </a>
          </Col>
          <Col lg="2" md="4" sm="6" className="col-6 order-lg-1">
            <a className="insta-item" href="#">
              <img className="img-fluid" src="assets/images/kids/insta/04.jpg" alt="" />
              <div className="insta-icon"><i className="lab la-instagram"></i></div>
            </a>
          </Col>
        </Row>
...
export default InstagramSectionKids;
