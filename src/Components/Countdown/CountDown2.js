  ...
  const CountdownRenderer = ({ days, hours, minutes, seconds }) => {
    return (
       ...
       {/* <ul className="countdown list-inline d-flex my-5">
        <li className="list-inline-item">{days}d</li>
        <li className="list-inline-item">{hours}h</li>
         <li className="list-inline-item">{minutes}m</li>
         <li className="list-inline-item">{seconds}s</li>
       </ul> */}
    <ul class="countdown list-inline d-flex my-5" data-countdown="2024/08/23"></ul>
    </>
    );
  };
