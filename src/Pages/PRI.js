                            ...
                            <div className="container">
                                <div className="row">
                                    ...
                                    <div className="col-lg-6 col-12">
                                        ...
                                        {/* <div className="owl-carousel no-pb" data-items="1"
                                            owl-nav='false' owl-dots='false' >
                                            {product.pictures.map((image, index) => (
                                                <div key={index} className="card-img-hover">
                                                    <img className="img-fluid w-100 card-img-hover" src={`assets/images/${image}`} alt="" />
                                                </div>
                                            ))}
                                        </div> */}
                                        {/* <div class="card-img-hover d-block">
                                            <img class="card-img-top card-img-back" src={`assets/images/${product.pictures[1]}`} alt="..." />
                                            <img class="card-img-top card-img-front" src={`assets/images/${product.pictures[1]}`} alt="..." />
                                        </div> */}
                                        <ReactImageGallery
                                        ...
                                        <TabPane tabId="1">
                                            ...
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-md-7 mt-5 mt-lg-0">
                                                    ...
                                                    <p>{product.description}</p> <a class="btn btn-primary btn-animated" href="#"><i
                                                        class="las la-long-arrow-alt-right mr-1"></i>Read More</a>
                                                </div>
                                            </div>                                            </TabPane>
                                        <TabPane tabId="2">
