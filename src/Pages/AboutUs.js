...
import { FaCreditCard, FaShippingFast, FaHistory, FaUndoAlt } from 'react-icons/fa';
...
function AboutUs() {
    ...
    const reasonsData = [
        {
            icon: <i class="las la-credit-card ic-3x text-primary"></i>,
            title: 'Credit Card',
            description: 'Serspiciatis unde omnis iste natus error sit.',
        },
        {
            icon: <i class="las la-shipping-fast ic-3x text-primary"></i>,
            title: 'Free Shipping',
            description: 'Serspiciatis unde omnis iste natus error sit.',
        },
        {
            icon: <i class="las la-history ic-3x text-primary"></i>,
            title: '24/7 Support',
            description: 'Serspiciatis unde omnis iste natus error sit.',
        },
        {
            icon: <i class="las la-undo-alt ic-3x text-primary"></i>,
